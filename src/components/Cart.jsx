...
const Cart = () => {
  ...
  return (
    <div>
      <div className="fixed top-16 w-full lg:w-[23.5%]  select-none">
        ...
        <div className=" relative px-2 border border-slate-300 h-[calc(100vh-120px)]">
          ...
          <Link
            to="/shopping_cart"
            className=" absolute text-center bottom-0 mb-4 left-0 right-0 m-auto bg-primaryButton hover:bg-primaryButtonHover text-white w-[90%] py-[6px] rounded-md"
          >
            Checkout
          </Link>
        </div>
